...
CREATE TABLE hr.paises (
                ...
                CONSTRAINT pais_pk PRIMARY KEY (id_pais, id_regiao)
);
...
CREATE SEQUENCE hr.localizacoes_id_localizacao_seq;

CREATE TABLE hr.localizacoes (
                id_localizacao INTEGER NOT NULL DEFAULT nextval('hr.localizacoes_id_localizacao_seq'),
                id_pais CHAR(2) NOT NULL,
                id_regiao INTEGER NOT NULL,
                endereco VARCHAR(50),
                uf VARCHAR(25),
                cidade VARCHAR(50),
                cep VARCHAR(12),
                CONSTRAINT id_localizacao PRIMARY KEY (id_localizacao, id_pais, id_regiao)
);
...
COMMENT ON COLUMN hr.localizacoes.id_regiao IS 'Chave estrangeira referênciando a região do pais';
...
ALTER SEQUENCE hr.localizacoes_id_localizacao_seq OWNED BY hr.localizacoes.id_localizacao;

CREATE SEQUENCE hr.departamentos_id_departamento_seq;

CREATE TABLE hr.departamentos (
                id_departamento INTEGER NOT NULL DEFAULT nextval('hr.departamentos_id_departamento_seq'),
                id_localizacao INTEGER NOT NULL,
                id_pais CHAR(2) NOT NULL,
                id_regiao INTEGER NOT NULL,
                nome VARCHAR(50),
                id_gerente INTEGER,
                CONSTRAINT id_departamento PRIMARY KEY (id_departamento, id_localizacao, id_pais, id_regiao)
);
...
COMMENT ON COLUMN hr.departamentos.id_pais IS 'Chave estrangeira referênciando o pais da localidade';
COMMENT ON COLUMN hr.departamentos.id_regiao IS 'Chave estrangeira referênciando a região do pais';
...
ALTER SEQUENCE hr.departamentos_id_departamento_seq OWNED BY hr.departamentos.id_departamento;

CREATE UNIQUE INDEX departamentos_idx
 ON hr.departamentos
 ( nome );

CREATE SEQUENCE hr.empregados_id_empregado_seq;

CREATE TABLE hr.empregados (
                id_empregado INTEGER NOT NULL DEFAULT nextval('hr.empregados_id_empregado_seq'),
...
COMMENT ON COLUMN hr.empregados.id_localizacao IS 'Chave estrangeira referênciando a tabela localizacoes';
COMMENT ON COLUMN hr.empregados.id_pais IS 'Chave estrangeira referênciando o pais da localidade';
COMMENT ON COLUMN hr.empregados.id_regiao IS 'Chave estrangeira referênciando a região do pais';


ALTER SEQUENCE hr.empregados_id_empregado_seq OWNED BY hr.empregados.id_empregado;

CREATE UNIQUE INDEX empregados_idx
 ON hr.empregados
 ( email );

CREATE SEQUENCE hr.historico_cargos_id_empregado_seq;

CREATE TABLE hr.historico_cargos (
                id_empregado INTEGER NOT NULL DEFAULT nextval('hr.historico_cargos_id_empregado_seq'),
...
COMMENT ON COLUMN hr.historico_cargos.id_localizacao IS 'Chave estrangeira referênciando a tabela localizacoes';
COMMENT ON COLUMN hr.historico_cargos.id_pais IS 'Chave estrangeira referênciando o pais da localidade';
COMMENT ON COLUMN hr.historico_cargos.id_regiao IS 'Chave estrangeira referênciando a região do pais';


ALTER SEQUENCE hr.historico_cargos_id_empregado_seq OWNED BY hr.historico_cargos.id_empregado;
...
REFERENCES hr.paises (id_pais, id_regiao)
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;
...
REFERENCES hr.localizacoes (id_regiao, id_pais, id_localizacao)
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;
...
REFERENCES hr.departamentos (id_departamento, id_localizacao, id_pais, id_regiao)
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;
